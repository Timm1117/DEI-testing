  ...
  return (
    <section className="rounded-lg border border-white/20 bg-gradient-to-br from-white/[0.08] to-white/[0.02] p-5 shadow-glow backdrop-blur-xl saturate-150">
      <div className="mb-5 flex items-end justify-between gap-4">
        <div>
          <h2 className="text-lg font-semibold text-white">文化價值與輿論影響指標</h2>
          <p className="mt-1 text-sm text-slate-300">依 mock data 模擬合規壓力與市場輿論，換算為 1-10 分。</p>
        </div>
      ...
      <div className="mb-6 rounded-lg border border-white/10 bg-black/25 p-4">
        <p className="text-xs uppercase tracking-[0.18em] text-slate-400">合規與輿論張力分級</p>
      ...
      <div className="mt-6 rounded-lg border border-white/10 bg-black/20 p-4">
        ...
        <p className="text-sm leading-6 text-slate-300">
          顏色代表外部合規引發社群反彈的張力程度，不代表作品好壞。越綠代表越不受文化戰干擾，
          越紅代表越容易陷入合規與核心玩家抵制的拉扯局面。
        </p>
      </div>
    </section>
  );
